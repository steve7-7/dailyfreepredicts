...
export default function Accumulators() {
  ...
  const [selectedAccumulator, setSelectedAccumulator] = useState<number | null>(
    null,
  );
    ...
    try {
      ...
      const errorMessage =
        err instanceof Error
          ? err.message
          : "An error occurred while fetching accumulators";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
          <div className="flex items-center justify-between h-14">
            ...
            <nav className="flex items-center gap-1 sm:gap-6 flex-1 justify-center">
              ...
              <Link
                to="/accumulators"
                className="px-3 py-2 text-sm font-medium text-primary bg-primary/10 rounded-lg font-semibold"
              >
                Accumulators
              </Link>
              <Link
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-12">
          ...
          <p className="text-lg text-slate-600 max-w-2xl">
            Explore high-potential accumulator combinations with multiple
            selections. Find the best multi-leg bets for maximum returns.
          </p>
        </div>
                ...
                <div>
                  ...
                  <p className="text-sm text-blue-700 mt-1">
                    {cacheInfo.cached
                      ...
                      : "Fresh data from API"}
                    {hoursUntilRefresh > 0 &&
                      ` • Next update in ${hoursUntilRefresh}h`}
                  </p>
                </div>
              </div>
              <button
                ...
                <div className="space-y-2 mb-4">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="font-semibold text-slate-900">
                      {acc.potential_return
                        ? `$${acc.potential_return.toFixed(2)}`
                        : "—"}
                    </span>
                  </div>
                </div>
        ...
        {!loading && accumulators.length === 0 && !error && (
          <div className="text-center py-16">
            ...
            <p className="text-slate-600 mb-6">
              Check back later for accumulator builds
            </p>
            <button
              onClick={fetchAccumulators}
